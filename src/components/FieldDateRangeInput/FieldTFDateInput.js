...
class FieldTFDateInputComponent extends Component {
  constructor(props) {
    super(props);
...
FieldTFDateInputComponent.defaultProps = {
  className: null,
  rootClassName: null,
...
FieldTFDateInputComponent.propTypes = {
  className: string,
